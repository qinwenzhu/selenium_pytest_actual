...
from guard.tools.package_db import query_result_by_database
...
class TestTimezone:
    ...
    def test_add_timezone(self, timezone_web, sole_time_name):
        # 测试添加时间条件
        TimezonePage(timezone_web).add_timezone_name(sole_time_name)

        print(sole_time_name)
        # 断言
    ...
    def test_add_timezone_and_beyond(self, timezone_web, sole_time_name):
        ...
        result = ""
        # 断言
        assert "请输入最多40个字符的事件条件名称" == result
