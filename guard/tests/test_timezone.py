...
class TestTimezone:
    ...
    def test_add_timezone(self, connect_mysql_and_close, timezone_web, sole_time_name_to_class):
        # 测试添加时间条件
        TimezonePage(timezone_web).add_timezone_name(sole_time_name_to_class)
