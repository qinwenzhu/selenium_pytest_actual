...
class GroupTree(BasePage):
    ...
    def click_menu_by_name(self, group_name, menu_name):
        ...
        # BasePage(self.driver).wait_for_ele_to_be_visible(GROUP_MENU_NAME)
        # ActionChains(self.driver).move_to_element(GROUP_ICON).click(GROUP_MENU_NAME).perform()
